// frontend/App.jsx
// Settings route REMOVED from here — it's now handled inside AdminLayout at /admin/settings
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* ✅ AdminLayout handles ALL /admin/* routes including /admin/settings */}
        <Route
          path="/admin/*"
          element={
            <ProtectedRoute>
        ...
        {/* Standalone Campaign Pages (outside admin layout) */}
